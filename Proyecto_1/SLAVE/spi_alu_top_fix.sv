...
module spi_alu_top_fix #(
    ...
    // ========================================================================
    // DECODIFICACIÓN DE COMANDOS   - Likely take this all out.
    // ========================================================================
    ...
    // ========================================================================
    // REGISTRO OP  - Take out. Switches are directly connected to ALU
    // ========================================================================
    ...
    assign operand_a_leds = 4'h4;  // MUST BE A_reg
